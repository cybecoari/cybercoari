...
<style>
/* O CSS (Style) permanece o mesmo que você forneceu */
...
<div style="text-align: center; margin-bottom: 30px; padding: 15px; background: rgba(30,30,40,0.95); border-radius: 15px;">
    <h2 style="margin-bottom: 10px;">Rádio Difusora 96.9 FM (O Amor do Amazonas)</h2>
    <iframe 
        src="https://www.radios.com.br/player/difusora-969-fm/12641" 
        frameborder="0" 
        scrolling="no" 
        allow="autoplay"
        width="50%" 
...
const mediaList=[
  ...
  /* REMOVEMOS O ITEM DA RÁDIO DIFUSORA DA LISTA (que estava como "Rádio Jazz") 
     para que ela não cause mais erro e o iframe acima cuide dela.
  {
      type:"radio", 
      name:"Rádio Jazz", 
      logo:"🎷", 
      nowPlaying:"Jazz suave", 
      src:"https://difusora24h.com/?hl=pt-BR"}
  */
];

// O restante do JavaScript permanece inalterado para continuar a gerenciar a lista acima.
